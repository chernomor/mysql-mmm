...
sub init($$) {
	...
	my $conf = "
		...
		log4perl.appender.FileInfo.filename   = $main::SELF_DIR/$progam.info
		...
		log4perl.appender.FileWarn.filename   = $main::SELF_DIR/$progam.warn
		...
		log4perl.appender.FileError.filename  = $main::SELF_DIR/$progam.error
		...
		log4perl.appender.FileFatal.filename  = $main::SELF_DIR/$progam.fatal
